        ...
        <div class="">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              ...
              <div class="x_content">
                  <form action ="../AddItem" method="post" name="my_form" class="form-horizontal form-label-left" enctype="Multipart/form-data" onSubmit="document.my_form.editor_contents.value = $('#editor').html()" >
                      <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Category">Main Category <span class="required"> *</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name ="categoryName" id="Category" class="form-control col-md-7 col-xs-12" required="" onchange="showState(this.value)">
                             <option value="none">Select</option>  
    <%
 Class.forName("com.mysql.jdbc.Driver").newInstance();  
 Connection cn = DriverManager.getConnection("jdbc:mysql://localhost:3306/demoproject","root","root");  
 Statement stmt = cn.createStatement();  
 ResultSet rs = stmt.executeQuery("Select * from categorytable where categoryStatus='active'");
 while(rs.next()){
     %>
      ...
      <%}%>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="title" pattern="([A-Za-z .])+" name="itemName" title="Enter Words Only" required="required" placeholder="Enter Title here" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="file" id="file" name="itemImage" required="required" class="form-control col-md-7 col-xs-12" onchange="return fileValidation()">
                      </div>
                    </div>
                      <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="price" pattern="[0-9]{1,8}" name="itemPrice" title="Enter Digits Only and it should not be more then INR 9.99 Crore" required="required" placeholder="Enter Price in &#8377" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="stock" pattern="[0-9]{1,20}" name="stock" title="Enter Digits Only" required="required" placeholder="Enter Stock Limit" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                        <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                         <select name ="featuredProduct" id="feature" class="form-control col-md-7 col-xs-12">
                       ...
                       <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12"  for="descr">Add Description: 
                      </label>
                           
          
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <textarea name="itemDes" class="form-control"></textarea>
                </div>
