...
public class DeleteGallery extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            PreparedStatement ps=cn.prepareStatement("delete from gallery where galleryId=?");
            ...
            if(i>0)
            {
                ...
                out.println("alert('Gallery Deleted Successfully!!')");
            ...
            {
                out.println("<script type=\"text/javascript\">");
                out.println("alert('Gallery Not Deleted!!')");
                out.println("window.location.href='admin/view_Gallery.jsp'");
                out.println("</script>");
            }
            }catch(Exception e)
