        ...
        try (PrintWriter out = response.getWriter()) {
            /* TODO output your page here. You may use following sample code. */
                    ...
                    if(filepart.getSize()>0)
             {
                ...
                PreparedStatement ps=cn.prepareStatement("update banner set bannerName=?,bannerStatus=? where bannerId=?");
                ps.setString(1, fileName);
                ps.setString(2, bannerStatus);
                ps.setString(3, bannerId);
                int i=ps.executeUpdate();
                if(i>0)
                {
                    out.println("<script type=\"text/javascript\">");
                out.println("alert('Banner Updated Successfully!!')");
                ...
                out.println("window.location.href='admin/edit_Banner.jsp'");
                out.println("</script>");
                    ...
                    {
                        PreparedStatement ps1=cn.prepareStatement("update banner set bannerStatus=? where bannerId=?");
                        ps1.setString(1, bannerStatus);
                        ps1.setString(2, bannerId);
