    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           try
           {
               ...
               PreparedStatement ps=cn.prepareStatement("update usertable set userName=?,userMobile=?,userImage=? where userId=?");
               ...
               if(i>0)
               {
                   out.println("<script type=\"text/javascript\">");
                    ...
                    out.println("window.location.href='womens/userDashboard.jsp'");
                    out.println("</script>");
               }
               else
               {
                   out.println("<script type=\"text/javascript\">");
                    ...
                    out.println("window.location.href='womens/editUser.jsp'");
                    out.println("</script>");
               }
               }
               else
               {
                   PreparedStatement ps1=cn.prepareStatement("update usertable set userName=?,userMobile=? where userId=?");
               ps1.setString(1, userName);
               ps1.setString(2, userMobile);
