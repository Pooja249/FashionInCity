    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           try
           {
               ...
               PreparedStatement ps=cn.prepareStatement("insert into subcategorytable(subCategoryName,subCategoryStatus,categoryId) values(?,?,?)");
               ...
               if(i>0)
               {
                ...
                out.println("alert('SubCategory Added Successfully!!')");
