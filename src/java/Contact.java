    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try
            {
                ...
                PreparedStatement ps=cn.prepareStatement("insert into contact(userName,userEmail,userMobile,message,status) values(?,?,?,?,?)");
                ...
                else
                {
                     ...
                     out.println("window.location.href='womens/mail.jsp'");
                     out.println("</script>");
                }
            }catch(Exception e)
            {
