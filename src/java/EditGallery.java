        ...
        try (PrintWriter out = response.getWriter()) {
            /* TODO output your page here. You may use following sample code. */
                    ...
                    if(filepart.getSize()>0)
             {
                ...
                PreparedStatement ps=cn.prepareStatement("update gallery set galleryName=?,galleryStatus=? where galleryId=?");
                ps.setString(1, fileName);
                ps.setString(2, galleryStatus);
                ps.setString(3, galleryId);
                int i=ps.executeUpdate();
                if(i>0)
                {
                    out.println("<script type=\"text/javascript\">");
                out.println("alert('Gallery Updated Successfully!!')");
                ...
                out.println("</script>");
                    ...
                    {
                        PreparedStatement ps=cn.prepareStatement("update gallery set galleryStatus=? where galleryId=?");
                
                ps.setString(1, galleryStatus);
                ps.setString(2, galleryId);
                int i=ps.executeUpdate();
                if(i>0)
                {
                    out.println("<script type=\"text/javascript\">");
