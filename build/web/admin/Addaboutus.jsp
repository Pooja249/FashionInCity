        ...
        <div class="">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              ...
              <div class="x_content">
                  <form action ="../UpdateAboutUs" method="post" name="my_form" class="form-horizontal form-label-left" onSubmit="document.my_form.editor_contents.value = $('#editor').html()" >
                    <%
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="title" pattern="([A-Za-z .])+" name="aName" title="Enter Words Only" value="<%=rs.getString("aName")%>" required="required" placeholder="Enter Title here" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div> 
                ...
                <textarea name="aDes" class="form-control col-md-8"><%=rs.getString("aDes")%></textarea>
                         </div>
                <br />
